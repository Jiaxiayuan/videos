...
<div id="courseBar" style="display: none;">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {fixed: 'right', title: '操作', toolbar: '#courseBar', align: 'center'}
            ]],
...
//            alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/course/loadAllCourse.action?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(courseTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.name + '】这个课程么？', function (index) {
                    //向服务端发送删除指令
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些课程么？', function (index) {
                //向服务端发送删除指令
